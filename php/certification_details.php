...
if (mysqli_num_rows($result) > 0) {
    ...
    $pass_address = '
        ...
        <form>
            <block>
                <prompt>'. 'The certification ID is:' . ' ' . $certification_id . ',' . 
                ' ' . 'The seed category is:'. ' ' . $seed_category . ',' . 
                ' ' . 'The label color is:' . ' ' . $label_color . ',' . 
                ' ' . 'The species is:' . ' ' . $species . ',' . 
                ' ' . 'The variety is:' . ' ' . $variety . ',' . 
                ' ' . 'The reference is:' . ' ' . $reference . ',' . 
                ' ' . 'The lot weight is:'. ' ' . $lot_weight . ' ' . 'Kilograms' . ',' . 
                ' ' . 'The number of bags is:'. ' ' . $number_of_bags . ',' . 
                ' ' . 'The weight of the bags is:'. ' ' . $weight_of_bags . ' ' . 'Kilograms' . ',' . 
                ' ' . 'The number of tags is:'. ' ' . $number_of_tags . '</prompt>
            </block>
        </form>
        </vxml>';
        print ($pass_address);
